...
use App\BuilderThree\Inventory;
use App\BuilderThree\Master;
use App\BuilderThree\MealBuilder;
use App\BuilderThree\Ingredients\Vege;
use App\BuilderThree\Ingredients\Chicken;
use App\BuilderThree\Ingredients\Sprite;
use App\BuilderThree\Ingredients\Water;
...
class MealBuilderTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->master->getBuilder()
            ...
            ->setItem(new Water(Inventory::WATER));
    ...
    public function testItems()
    {
        ...
        $this->assertEquals(Inventory::WATER, $this->menu->getComponent(Water::class)->getItem());
    }
